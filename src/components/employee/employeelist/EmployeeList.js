...
export default function EmployeeList() {
  ...
  const emptyRows =
    rowsPerPage -
    Math.min(rowsPerPage, employeeDetails.length - page * rowsPerPage);
              ...
              {stableSort(employeeDetails, getComparator(order, orderBy))
                ...
                .map((employee, index) => {
                  ...
                  return (
                    <TableRow
                      hover
                      onClick={(event) => handleClick(event, employee.name)}
                      role="checkbox"
                    ...
                    >
                      ...
                      <TableCell align="right">{employee.department_id}</TableCell>
